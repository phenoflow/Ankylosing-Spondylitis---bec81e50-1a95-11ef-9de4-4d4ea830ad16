...
codes = [{"code":"G754.00","system":"readv2"},{"code":"N10z.00","system":"readv2"},{"code":"N101.00","system":"readv2"},{"code":"43b2.00","system":"readv2"},{"code":"N102.00","system":"readv2"},{"code":"N100.11","system":"readv2"}];
REQUIRED_CODES = 1;
